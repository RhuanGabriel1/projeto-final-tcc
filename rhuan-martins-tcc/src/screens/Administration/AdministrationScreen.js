...
const ManualOperations = () => {
  ...
  const options = [
    { label: "R$/ciclo", value: "R$/ciclo" },
    { label: "R$/semana", value: "R$/semana" },
    { label: "R$/mês", value: "R$/mês" },
      ...
      <KeyboardAvoidingView style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
          ...
          <Input
            ...
            placeholder={"Custo individual do serviço"}
          ...
          <Input
            label="Quantidade"
            placeholder="Quantidade de prestação do serviço"
            keyboardType="numeric"
            value={val2}
